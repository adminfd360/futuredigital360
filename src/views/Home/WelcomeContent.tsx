  ...
  return (
    <div className="relative overflow-x-hidden">
      ...
      <Section>
        ...
        >
          Since 1986 <strong>Future Digital 360</strong> has provided innovative
          and effective business solutions globally. We specialize in electronic
          document management, managed print services and advanced office
          technology scanning solutions. We provide dedicated, dependable and
          unparalleled customer support. We tailor innovative solutions to fully
          meet each of our customer’s individual needs. Our solutions include:
        </Text>
